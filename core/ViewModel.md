...
### Example04: ViewModel(View), Lifecycle Awareness
#### File System
```
.Project
├── app
...
### Example07: Application(Context) + ViewModel(AndroidViewModel)
#### File System
```
.Project
├── app
