...
class RemoteService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        thread {
            ...
            editor.putString("lastOperation", "Database operation completed")
            editor.apply()

            Handler(Looper.getMainLooper()).post {
                // Process the list, update UI, etc.
                val lastOperation = sharedPreferences.getString("lastOperation", "No operation")
                Toast.makeText(applicationContext, "$lastOperation", Toast.LENGTH_SHORT).show()
            }
        }
