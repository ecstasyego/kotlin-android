...
object AppContainer {
    ...
    val useCase: GetUseCase = GetUseCase(repository)
    val mainViewModel: MainViewModelFactory = MainViewModelFactory(useCase)
...
class MainActivity : AppCompatActivity() {
    private val viewModel: MainViewModel by viewModels { AppContainer.mainViewModel } // Lifecycle Awareness
