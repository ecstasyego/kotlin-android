...
### Example04: DI(Dependency Injection) for View
#### File System
```
.Project
├── app
...
### Example05: DI(Dependency Injection) for ViewModel
#### File System
```
.Project
├── app
...
### Example06: DI(Dependency Injection) for Service
#### File System
```
.Project
├── app
...
### Example07: DI(Dependency Injection) for single, viewModel, factory
#### File System
```
.Project
├── app
