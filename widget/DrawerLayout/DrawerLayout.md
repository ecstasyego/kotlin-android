...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val drawerMenuLayout = LinearLayout(this).apply {
            ...
            layoutParams = DrawerLayout.LayoutParams( DrawerLayout.LayoutParams.MATCH_PARENT, DrawerLayout.LayoutParams.MATCH_PARENT).apply { gravity = Gravity.LEFT }
        ...
        drawerMenuLayout.addView(
            TextView(this).apply {
                ...
                setOnClickListener {
                    ...
                    drawerLayout.closeDrawer(Gravity.LEFT) // 드로어 닫기
                }
            }
        )
        drawerMenuLayout.addView(
