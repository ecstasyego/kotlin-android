...
### Example03: ViewModel(*Views) with ViewModelProvider.Factory
#### File System
```
.Project
├── app
...
### Example05: ViewModel(*Views) with DI(koin, Application)
#### File System
```
.Project
├── app
...
### Example06: ViewModel(*Views) with DI(koin, Application, AppContainer)
#### File System
```
.Project
├── app
